...
const data = ref(reservationStore.countTotalEvent(props.day));

watch(
  () => reservationStore.countTotalEvent(props.day),
  () => {
    data.value = reservationStore.countTotalEvent(props.day);
  }
);
