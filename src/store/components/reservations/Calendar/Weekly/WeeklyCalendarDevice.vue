        ...
        >
          <div :class="['day__title']">
            ...
            <div class="day__title__count">
              <CountReservationDeviceInDay :day="moment(day.time)" />
            </div>
          </div>
          ...
          <ReservationInDayDevice :day="moment(day.time)" />
        </div>
      </div>
    </el-scrollbar>
  </div>
...
import CountReservationDeviceInDay from "../../Content/CountReservationDeviceInDay.vue";
import ReservationInDayDevice from "../../Reservation/Weekly/ReservationInDayDevice.vue";
