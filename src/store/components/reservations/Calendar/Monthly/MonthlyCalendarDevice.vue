      ...
      <el-scrollbar>
        ...
        >
          ...
          <div
            ...
            class="day__content"
          >
            <TimeFrameMonthDevice :day="moment(day.time)" />
          </div>
          <!-- END -->
          <!-- START -->
          <div
            v-else-if="day.type === TypeTime.currentMonth"
            class="day__content"
          >
            <TimeFrameMonthDevice :day="moment(day.time)" />
          </div>
...
import TimeFrameMonthDevice from "../../TimeFrame/TimeFrameMonthDevice.vue";
...
const resultStatusBooking = ref(reservationStore.getStatusBookingDevice);

watch(
  () => reservationStore.getStatusBookingDevice,
  () => {
    resultStatusBooking.value = reservationStore.getStatusBookingDevice;
  }
);
</script>
