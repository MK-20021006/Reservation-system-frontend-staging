<template>
  <div v-if="adsPC" class="external-ads">
    <div class="external-ads__PC external-ads__Mobile">
      <div class="external-ads__side a3">
...
const props = withDefaults(defineProps<A3Props>(), {
  position: () => [positionData.A3],
  storeId: null,
});
...
@import "../../../assets/scss/components/ads/a3.scss";
</style>
